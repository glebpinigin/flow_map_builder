...
class FlowMapBuilder:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FlowMapBuilder_{}.qm'.format(locale))
        ...
        #print "** INITIALIZING FlowMapBuilder"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FlowMapBuilder', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/flow_map_builder/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Build Flow Map'),
            callback=self.run,
